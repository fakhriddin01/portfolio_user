<template>
    <div class="px-[148px]  justify-between bg-white h-[396px]">
            ...
            <div class="flex gap-5">
                ...
                <router-link  v-for="el in posts" :to="{ name: 'blog', params: { id: el.id }}" :key="el.id" @click="openPost(el.id)" class="bg-[#EDF7FA] w-[50%] rounded-xl p-[24px]">
