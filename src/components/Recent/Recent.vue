<template>
    <div class="px-3 lg:px-[148px]  justify-between bg-[#EDF7FA] mb-[30px] lg:mb-[50px]">
            ...
            <div class="flex flex-col lg:flex-row gap-5">
                ...
                <router-link  v-for="el in posts" :to="{ name: 'blog', params: { id: el.id }}" :key="el.id" @click="openPost(el.id)" class="bg-[#EDF7FA] lg:w-[50%] rounded-xl p-[24px]">
